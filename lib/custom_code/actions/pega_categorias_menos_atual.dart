...
Future<dynamic> pegaCategoriasMenosAtual(
  String categoriaatual,
) async {
  // Constrói a URI com query parameter (MESMA LÓGICA DA OUTRA FUNÇÃO)
  final Uri uri = Uri.parse(
    'https://x8ki-letl-twmt.n7.xano.io/api:qWgZGSBh/pegaCategoriasMenosAtual',
  ).replace(queryParameters: {'categoriaatual': categoriaatual.trim()});
