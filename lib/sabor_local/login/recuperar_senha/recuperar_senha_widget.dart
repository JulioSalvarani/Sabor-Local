...
class RecuperarSenhaWidget extends StatefulWidget {
  ...
  static String routeName = 'Recuperar_Senha';
...
class _RecuperarSenhaWidgetState extends State<RecuperarSenhaWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFFDB3540),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Nós iremos enviar um link para trocar a senha da sua conta abaixo, não se desespere!',
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.emailAddressTextController.text != '') {
                          _model.pin = await actions.geraPin();
                          FFAppState().email =
                              _model.emailAddressTextController.text;
                          safeSetState(() {});
                          await actions.editarCodigoNoBanco(
                            _model.emailAddressTextController.text,
                            _model.pin!,
                          );
                          await actions.codSendGrid(
                            'julio.salvarani@aluno.faculdadeimpacta.com.br',
                            _model.emailAddressTextController.text,
                            'Esqueci minha senha - Código de Verificação',
                            'Seu código de verificação é: ${_model.pin}',
                          );

                          context.pushNamed(CodigoSenhaWidget.routeName);
                        } else {
                          await showDialog(
                            context: context,
                            builder: (dialogContext) {
                              return Dialog(
                                ...
                                child: AlertTemplateWidget(
                                  titulo: 'O campo email não está prenchido',
                                  menssagem:
