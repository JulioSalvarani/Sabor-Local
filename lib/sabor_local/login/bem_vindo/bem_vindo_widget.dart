...
class BemVindoWidget extends StatefulWidget {
  ...
  static String routeName = 'Bem_Vindo';
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 48.0, 0.0, 0.0),
                                        child: Text(
                                          'Restaurante focado em comida mineira, o melhor do brasil',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 48.0, 0.0, 0.0),
                                        child: Text(
                                          'Trazendo comida de qualidade quente até sua porta',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 48.0, 0.0, 0.0),
                                        child: Text(
                                          'Te trazendo comida boa, mas agora ainda mais fácil com entrega em casa',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.pageViewCurrentIndex == 2) {
                            ...
                            FFAppState().intro = !(FFAppState().intro ?? true);
                            safeSetState(() {});
                          }
                        },
                        text: 'Continue',
