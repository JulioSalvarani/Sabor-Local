                                          ...
                                          child: TextFormField(
                                            ...
                                            onFieldSubmitted: (_) async {
                                              if ((_model.nomeCompletoTextController.text != '') &&
                                                ...
                                                safeSetState(() {});
                                                _model.pinCopy =
                                                    await actions.geraPin();
                                                FFAppState().codigo =
                                                    _model.pinCopy!;
                                                _model.authTokenCopy =
                                                    await actions.fazCadastro(
                                                  _model
                                                ...
                                                if (FFAppState().authToken !=
                                                  ...
                                                  _model.chamaEndPoint2Copy =
                                                      await actions.codSendGrid(
                                                    'julio.salvarani@aluno.faculdadeimpacta.com.br',
                                                    FFAppState().email,
                                                    '[SABOR LOCAL] - Código de Verificação',
                                                    'Seu código de verificação é : ${FFAppState().codigo}',
                                                  );

                                                  context.pushNamed(
                                                      CodigoWidget.routeName);
                                                } else {
                                                  await showDialog(
                                                    context: context,
                                                    builder: (dialogContext) {
                                                    ...
                                                    return Dialog(
                                                      ...
                                                      child: GestureDetector(
                                                        ...
                                                        child:
                                                          ...
                                                          menssagem:
                                                              'Algum campo está vazio ou incoerente.',
                                                        ),
                                                      ),
                                                    );
                                                  },
                                          ...
                                          if ((_model.nomeCompletoTextController
                                            ...
                                            if (_model.valido!) {
                                              ...
                                              if (FFAppState().authToken !=
                                                ...
                                                await actions.fazCadastroASAAS(
                                                  FFAppState().authToken,
                                                );
                                                  ...
                                                  return Dialog(
                                                    ...
                                                    child: GestureDetector(
                                                      ...
                                                      child:
                                                        ...
                                                        titulo: 'CPF Inválido',
                                                        menssagem:
                                                            'Os parâmetros de CPF não são válidos. Confira o campo.',
                                                      ),
                                                    ),
                                                  );
                                                },
