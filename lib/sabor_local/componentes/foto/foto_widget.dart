...
class FotoWidget extends StatefulWidget {
  const FotoWidget({
    super.key,
    required this.fotoPerfilDatabase,
  });

  final String? fotoPerfilDatabase;
...
class _FotoWidgetState extends State<FotoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.imagematual = widget.fotoPerfilDatabase;
      safeSetState(() {});
    });
  }
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                          .isDataUploading_fotoenviada = true);
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_fotoenviada =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_fotoenviada =
                                    ...
                                    _model.foto = await actions.enviarFoto(
